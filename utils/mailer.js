...
export const sendPasswordResetEmail = async ({ email, name, resetUrl }) => {
  ...
  await transporter.sendMail({
    from,
    to: email,
    subject: "Restablecer contraseña - PETRO-SIGTI",
    text: `Hola ${name}, para restablecer tu contraseña ingresa a este enlace: ${resetUrl}. Este enlace expirará en 15 minutos.`,
    html: `
      <p>Hola ${name},</p>
